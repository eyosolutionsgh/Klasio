...
/**
 * The slug of the second tenant the cross-tenant tests need.
 *
 * Lives here rather than in the harness because global-setup has to clear the previous run's
 * copy before the seed runs, and must not pull the whole Nest application in to learn its name.
 */
export const OTHER_SCHOOL_SLUG = 'integration-other-school';
